    ...
    <BreezeAuthenticatedLayout>
       ...
       <div class="py-12">
        ...
        <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white rounded-lg p-6">
                <div class="flex items-center space-x-6 mb-4">
                   <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 14l9-5-9-5-9 5 9 5z"></path><path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222"></path></svg>
                    <div>
                        <p class="text-xl text-gray-700 font-normal mb-1">Seminars</p>
                        <p class="text-base text-blue-500 font-normal">Continuous learning</p>
                    </div>
                </div>
                <div>
            ...
            <div v-if="$props.auth.user.isAdmin" class="bg-white rounded-lg p-6">
                <div class="flex items-center space-x-6 mb-4">
                    <div class="p-3 rounded-full bg-blueish bg-opacity-75">
                    ...
                    <div>
                        <p class="text-xl text-gray-700 font-normal mb-1">Users</p>
                       <div class="text-gray-500">Total: {{users.length}}</div>
                    </div>
            ...
            <div v-if="!$props.auth.user.isAdmin" class="bg-white rounded-lg p-6">
                <div class="flex items-center space-x-6 mb-4">
                   <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2"></path></svg>
                    <div>
                        <p class="text-xl text-gray-700 font-normal mb-1">Patients</p>
                        <p class="text-base text-blue-500 font-normal">Sessions, notes & more</p>
                    </div>
                </div>
                <div>
                    <p class="text-gray-500 leading-loose font-normal text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            ...
            <div v-if="!$props.auth.user.isAdmin" class="bg-white rounded-lg p-6">
                <div class="flex items-center space-x-6 mb-4">
                    ...
                    <div>
                        <p class="text-xl text-gray-700 font-normal mb-1">Contact</p>
                        <p class="text-base text-blue-500 font-normal">Get in touch</p>
                    </div>
                </div>
                <div>
                    <p class="text-gray-500 leading-loose font-normal text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
