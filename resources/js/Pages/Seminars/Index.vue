        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-2">
                    <div
                        v-if="
                            $page.props.auth.user.isAdmin == false &&
                            $page.props.auth.user.seminars.length > 0
                        "
                    ...
                    >
                        <BreezeButton>
                            <a :href="route('seminars_create')" method="get"
                                >Create</a
                            ></BreezeButton
                        >
                    </div>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <a
                                                        :href="`/seminars/${seminar.id}/subscribers`"
                                                        method="get"
                                                        >Full</a
                                                    >
                                                </span>
