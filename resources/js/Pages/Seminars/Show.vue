                ...
                <div class="flex justify-between -mt-4 px-4">
                    ...
                    >
                        <p class="text-white font-semibold text-sm">
                            {{
                                $props.seminar.availability -
                                $props.seminar.users.length
                            }}/{{ $props.seminar.availability }}
                        </p>
                    </span>
                </div>
                ...
                <div class="flex flex-row items-end h-full w-full px-4 mt-4">
                    ...
                    <div class="mr-8">
                        <BreezeButton
                            ...
                            "
                            ><a :href="`/subscribe/${seminar.id}`" method="get"
                                >Subscribe</a
                            ></BreezeButton
                        >

                        <BreezeButton
                            v-if="isSubscribed && !$props.auth.user.isAdmin"
                            ><a
                                :href="`/unsubscribe/${seminar.id}`"
                                method="get"
                                >Unsubscribe</a
                            ></BreezeButton
                        >
                        ...
                        <div
                            v-if="$props.auth.user.isAdmin"
                            class="inline-flex"
                        >
                            <BreezeButton
                                class="bg-green-700 hover:bg-green-800 mr-3"
                                ><a
                            ...
                            <BreezeButton
                                class="bg-red-700 hover:bg-red-800 mr-3"
                                @click.prevent="deleteSeminar(`${seminar.id}`)"
                                >Delete</BreezeButton
                            >
                        </div>
                    </div>
