    ...
    <BreezeAuthenticatedLayout>
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div v-if="$page.props.session.cart" class="h-screen bg-gray-300 shadow-sm sm:rounded-lg">
    <div class="py-12">
                ...
                <div class="w-full p-4 px-5 py-5">
                    <div class="md:grid md:grid-cols-3 gap-2 ">
                        <div class="col-span-2 p-5">
                            ...
                            <div v-for="product in $page.props.products" v-bind:key="product" class="flex justify-between items-center mt-6 pt-6">
                                <div class="flex items-center"> <img :src="`${product.item.image}`" width="60" class="rounded-full ">
