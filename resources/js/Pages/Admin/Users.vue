<template>
    ...
    <div class="py-12">
           ...
           <div class="p-4 flex inline-block mt-3 mb-3 justify-between">
              ...
              >Admin Users</a
            ></div>
            <div v-if="users.data.length > 0" class="flex inline-block">
               ...
               <BreezeInput class="mr-12" id="search" type="text" v-model="term" @keyup="search"></BreezeInput>
                ...
                <BreezeButton v-if="users.data.length > 0" class="bg-red-400 hover:bg-red-500 mr-4" @click.prevent="deleteAll()">Delete All</BreezeButton>
